...
import ru.investflow.mqlidea2.parser.parsing.util.ParsingScope;
import ru.investflow.mqlidea2.parser.parsing.util.ParsingUtils;
import ru.investflow.mqlidea2.parser.parsing.util.PatternMatcher;
import ru.investflow.mqlidea2.psi.MQL4Elements;
import ru.investflow.mqlidea2.psi.MQL4TokenSets;
import ru.investflow.mqlidea2.util.ObjectUtils;
...
import static ru.investflow.mqlidea2.parser.parsing.FunctionsParsing.FunctionParsingResult.Declaration;
import static ru.investflow.mqlidea2.parser.parsing.FunctionsParsing.FunctionParsingResult.Definition;
import static ru.investflow.mqlidea2.parser.parsing.FunctionsParsing.FunctionParsingResult.NotMatched;
import static ru.investflow.mqlidea2.parser.parsing.util.ParsingErrors.UNEXPECTED_TOKEN;
import static ru.investflow.mqlidea2.parser.parsing.util.ParsingErrors.error;
import static ru.investflow.mqlidea2.parser.parsing.util.ParsingUtils.advanceLexerUntil;
import static ru.investflow.mqlidea2.parser.parsing.util.ParsingUtils.hasElementInRange;
import static ru.investflow.mqlidea2.parser.parsing.util.ParsingUtils.matchSequenceN;
import static ru.investflow.mqlidea2.parser.parsing.util.ParsingUtils.parseTokenOrFail;
import static ru.investflow.mqlidea2.parser.parsing.util.TokenAdvanceMode.ADVANCE;

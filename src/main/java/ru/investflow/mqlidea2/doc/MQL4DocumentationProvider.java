...
import ru.investflow.mqlidea2.psi.impl.MQL4DocLookupElement;
import ru.investflow.mqlidea2.settings.MQL4PluginSettings;
...
public class MQL4DocumentationProvider extends DocumentationProviderEx implements ExternalDocumentationHandler {
    ...
    private String docLinkToResourcePath(@NotNull String link) {
        ...
        if (anchorIdx == -1) {
            return "doc/" + lang + "/" + link + ".html";
        }
        return "doc/" + lang + "/" + link.substring(0, anchorIdx) + ".html";
    }
    ...
    public String getDocsLanguage() {
        ...
        return settings == null ? "en" : settings.isUseEnDocs() ? "en" : "ru";
    }
}
